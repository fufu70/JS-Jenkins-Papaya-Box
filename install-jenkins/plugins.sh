...
sudo java -jar jenkins-cli.jar -s http://localhost:8080 install-plugin plot pmd violations warnings junit dry sidebar-link --username "$J_USERNAME" --password "$J_PASSWORD"
