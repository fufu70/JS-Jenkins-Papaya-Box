...
cp ~/install-jenkins/data/pile-of-poo.png /var/lib/jenkins/userContent/poo.png
cp ~/install-jenkins/data/pile-of-poo.png /var/lib/jenkins/userContent/coverage.ico